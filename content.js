var FindingObservation={
    ...
    "subject": {
      "reference": "Patient/9250966",
      "display": "張晉嘉"
    },
    "effectiveDateTime": "2015-02-07T13:28:17-05:00",
    "performer": [ {
      "reference": "Practitioner/9250967",
...
{
    //把網頁輸入的資料填入JSON
    FindingObservation.component[1].valueString=document.getElementsByName("aneurysm").value;
    FindingObservation.component[2].valueString=document.getElementsByName("stenosis").value;
    FindingObservation.component[3].valueString=document.getElementsByName("other").value;
